...
namespace Modules\PowertranzPaymentGateway\Http\Traits;


use Modules\PowertranzPaymentGateway\Http\Helpers\GlobalCurrency;
...
trait ConvertUsdSupport
{
    ...
    protected function get_amount_in_usd($amount){
        ...
        if ($payable_amount < 1) {
            return $payable_amount . __('USD amount is not supported by Powertranz');
        }
